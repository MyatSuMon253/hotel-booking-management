...
export const permissions = shield(
  {
    Query: {
      ...
      getAllDishes: and(isAuthenticated, isAdmin),
      getDishById: and(isAuthenticated, isAdmin),
      getAllBuffetDinners: and(isAuthenticated, isAdmin),
      getAvailableBuffetDinners: isAuthenticated,
      getBuffetDinnerById: isAuthenticated,
      getAllBuffetBookings: and(isAuthenticated, isAdmin),
      getBuffetBookingById: isAuthenticated,
      getBuffetBookingsByUser: isAuthenticated,
    ...
    Mutation: {
      ...
      createBuffetDinner: and(isAuthenticated, isAdmin),
      updateBuffetDinner: and(isAuthenticated, isAdmin),
      deleteBuffetDinner: and(isAuthenticated, isAdmin),
      createBuffetBooking: isAuthenticated,
      updateBuffetBookingPayment: isAuthenticated,
      cancelBuffetBooking: isAuthenticated,
      stripeBuffetCheckoutSession: isAuthenticated,
